...
export default function WorkVisaPage() {
  return (
    <>
      <Helmet>
        <title>Work Visa Consultancy | Japan SSW, Australia 482, Canada Express Entry, UK Skilled Worker</title>
        <meta
          name="description"
          content="Apply for work visas to Japan (SSW), Australia (482 / 186), Canada (Express Entry, LMIA), UK (Skilled Worker), Germany (EU Blue Card), New Zealand (AEWV), Russia (HQS), and the USA (H-1B / EB-3) with Siddhivinayak Overseas."
        />
        <meta
          name="keywords"
          content="work visa consultancy, Japan SSW visa, Australia 482 visa, Canada Express Entry, UK Skilled Worker visa, Germany EU Blue Card, NZ AEWV, Russia HQS visa, USA H-1B, overseas work permit"
        />
      </Helmet>
      <SiteHeader />
