...
export default function StudyVisaPage() {
  return (
    <>
      <Helmet>
        <title>Study Visa Consultancy | UK, France, Germany University Admissions</title>
        <meta
          name="description"
          content="Apply for study visas to top universities in the UK, France, and Germany. Expert counselling, admission support, and visa filing with Siddhivinayak Overseas."
        />
      </Helmet>
      <SiteHeader />
