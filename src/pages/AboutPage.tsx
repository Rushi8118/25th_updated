...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>About Us | Siddhivinayak Overseas</title>
        <meta
          name="description"
          content="Siddhivinayak Overseas is a trusted MEA-registered visa consultancy helping students and skilled workers move to Japan, Australia, Canada, UK, Germany, NZ, Russia, and the USA."
        />
      </Helmet>
      <SiteHeader />
      <main className="relative overflow-hidden premium-page">
        <PageHero
          ...
          description="We are a specialist overseas consultancy guiding students and skilled professionals to reputable universities and employers across the world."
